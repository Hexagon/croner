...
module.exports = function (Cron) {
	...
	describe("Scheduler", function () {
		...
		it("Test when next thursday 1st november occurr, starting from 2021-10-13 00:00:00", function () {
			Cron("0 0 0 1 11 4", {timezone: "Europe/Stockholm"}).next(new Date(1634076000000)).getTime().should.equal(1888182000000);
			Cron("0 0 0 1 11 4", {timezone: "Europe/Stockholm"}).next(new Date(1634076000000)).getFullYear().should.equal(2029);
		});
